...
function CustomerFeedbacks(props) {
    ...
    const handleApprovePayment = () => {
        ...
        Swal.fire({
            title: "Are you sure?",
            text: "You want to confirm this refund",
            icon: "question",
    ...
    const handleFormData = (e) => {
        ...
        if (e.target.name == "refund_type") {
            ...
            if (e.target.value == "Reject Refund Request") {
                setRefundCustomerData({ refundCustomerData, refund_type: e.target.value, refunding_amount: 0.00, refund_status: true })
            }
            else {
                setRefundCustomerData({ refundCustomerData, refund_type: e.target.value, refunding_amount: orderData.total_amount, refund_status: false })
            }
