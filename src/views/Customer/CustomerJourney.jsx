...
import AnalyticsTab from './AnalyticsTab'; // Assuming you will create this file
...
const CustomerJourney = () => {
  ...
  const [activeTab, setActiveTab] = useState('CustomerJourney'); // New state for tabs
  ...
  useEffect(() => {
    if (activeTab === 'CustomerJourney') {
      fetchAnalyticsData(currentPage, perPage, sortBy, sortDirection, debouncedSearchTerm);
    }
  }, [currentPage, perPage, sortBy, sortDirection, debouncedSearchTerm, fetchAnalyticsData, activeTab]);
  ...
  return (
    <div>
          ...
          <CCard className="customer-details-card border-0 shadow-sm">
            <CCardBody className="p-4">
              <CNav variant="tabs">
                <CNavItem>
                  <CNavLink
                    active={activeTab === 'CustomerJourney'}
                    onClick={() => setActiveTab('CustomerJourney')}
                  >
                    Customer Journey
                  </CNavLink>
                </CNavItem>
      ...
      <CTabContent>
        <CTabPane role="tabpanel" visible={activeTab === 'CustomerJourney'}>
          {loading ? (
            <CRow>
              <CCol>
                <CCard className="customer-details-card border-0 shadow-sm">
            ...
            <CModalBody className="bg-light py-4">
              {modalLoading ? (
                ...
                <div>
                  ...
                  <CTabContent>
                    <CTabPane visible={activeModalTab === 'data'}>
                      <CRow className="mb-4">
                        <CCol>
                        ...
                        <CCol md={3}>
                          <CCard className="stats-card h-100">
                            <CCardBody className="d-flex flex-column align-items-center">
                              ...
                              <CBadge color="warning" className="badge-subtle">
                                Avg:{' '}
                                {formatDuration(selectedCustomerDetails.stats.avg_session_duration)}
                              </CBadge>
                            </CCardBody>
                          </CCard>
                        </CCol>
                                  ...
                                  <div key={index} className="device-info-card p-3 rounded-3">
                                    ...
                                    <div className="d-flex gap-4 text-muted small">
                                      <div>
                                        ...
                                        />
                                        First:{' '}
                                        {parseBackendDate(device.first_seen).toLocaleDateString()}{' '}
                                      ...
                                      <CTableRow key={index}>
                                        ...
                                        <CTableDataCell>
                                          <div>
                                            ...
                                            <div className="text-muted small">
                                              {session.device.system_name}{' '}
                                              {session.device.system_version}
                                            </div>
                                          </div>
                                        </CTableDataCell>
                    ...
                    <CTabPane visible={activeModalTab === 'charts'}>
                      <CRow className="mb-4 g-3">
                        <CCol md={12}>
                          <CCard className="customer-details-card h-100">
                            <CCardHeader className="border-bottom bg-transparent p-4">
                              <div className="d-flex align-items-center">
                                <div className="rounded-circle bg-primary bg-opacity-10 p-2 me-3">
                                  <CIcon icon={cilClock} className="text-primary" />
                                </div>
                                <h5 className="mb-0">Session Duration Over Time</h5>
                              </div>
                            </CCardHeader>
                            <CCardBody className="p-4">
                                ...
                                <CChartLine
                                  data={{
                                    labels: selectedCustomerDetails.sessions.map((s) =>
                                      parseBackendDate(s.created_at).toLocaleString(),
                                    ),
                                    datasets: [
                                      {
                                        label: 'Duration (minutes)',
                                        data: selectedCustomerDetails.sessions.map((s) =>
                                          Math.round((s.total_session_duration || 0) / 60),
                                        ),
                                        borderColor: '#321fdb',
                                  ...
                                  options={{
                                    ...
                                    scales: {
                                      ...
                                      x: { title: { display: true, text: 'Session Time' } },
                                    },
                          ...
                          <CCard className="customer-details-card h-100">
                            <CCardHeader className="border-bottom bg-transparent p-4">
                              <div className="d-flex align-items-center">
                                ...
                                <h5 className="mb-0">Route Visits</h5>
                              </div>
                            </CCardHeader>
                            <CCardBody className="p-4">
                                ...
                                <CChartBar
                                  data={{
                                    ...
                                    datasets: [
                                      {
                                        label: 'Total Visits',
                                        data: selectedCustomerDetails.routes.map(
                                          (r) => r.total_visits || 0,
                                        ),
                          ...
                          <CCard className="customer-details-card h-100">
                            <CCardHeader className="border-bottom bg-transparent p-4">
                              <div className="d-flex align-items-center">
                                ...
                                <h5 className="mb-0">Device Sessions Distribution</h5>
                              </div>
                            </CCardHeader>
                            <CCardBody className="p-4">
                                ...
                                <CChartDoughnut
                                  data={{
                                    ...
                                    datasets: [
                                      {
                                        label: 'Sessions',
                                        data: selectedCustomerDetails.devices.map(
                                          (d) => d.sessions_count || 0,
                                        ),
                                        backgroundColor: [
                                          '#5c6ac4',
                                          '#36a2eb',
