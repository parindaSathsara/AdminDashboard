...
export default function HotelsOrderView(props) {
  ...
  const fetchBookingData = async (data) => {
    console.log(data, 'Data value isXXXXXXXXXXXXXXX')
    try {
      let url = ''
  ...
  console.log(basicDetails, 'BasiccccXXXXX')

  useEffect(() => {
    // fetchBookingData(props.productData);
    // setBasicDetails(props?.productData)
    // console.log(props?.productData?.Provider, 'Provider isssssssssssssXXXX')

    if (props?.productData?.Provider === 'hotelAhs') {
      setBasicDetails(props?.productData)
    } else {
      fetchBookingData(props.productData)
      setBasicDetails(props?.productData)
  ...
  return (
    ...
    >
      {(props?.productData?.Provider == 'hotelAhs' ||
        props?.productData?.Provider === 'ratehawk') && (
        <div
          style={{
        ...
        >
              ...
              >
                ...
                <p style={{ margin: '8px 0', fontSize: '15px' }}>
                  ...
                  <span
                    style={{
                      color:
                        basicDetails?.status === 'CustomerOrdered'
                          ? '#f39c12'
                          : basicDetails?.status === 'Confirmed'
                          ? '#27ae60'
                          : '#e74c3c',
                      fontWeight: 'bold',
                      backgroundColor:
              ...
              >
                ...
                >
                  ...
                  <div style={{ textAlign: 'center', flex: '1' }}>
                    ...
                    >
                      {moment(basicDetails?.checkInDate, 'DD/MM/YYYY')
                        .add(basicDetails?.NoOfNights, 'days')
                        .format('MMM D')}
                    </p>
                    <p style={{ margin: '3px 0 0 0', fontSize: '14px' }}>
                      {moment(basicDetails?.checkInDate, 'DD/MM/YYYY')
          ...
          >
            <div style={{ flex: '1', minWidth: '300px' }}>
              <p
                style={{ margin: '5px 0', fontSize: '20px', fontWeight: 'bold', color: '#2c3e50' }}
              >
              ...
              <div style={{ display: 'flex', alignItems: 'center', marginBottom: '10px' }}>
                ...
                <div style={{ display: 'inline-block' }}>
                  {Array(starCount)
                    .fill(0)
                    .map((_, i) => (
                      <span key={i} style={{ color: '#f39c12', fontSize: '16px' }}>
                        ★
                      </span>
                    ))}
                </div>
            ...
            >
              ...
              <CImage
                src={
                  basicDetails?.product_image?.includes(',')
          ...
          >
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '25px', marginBottom: '20px' }}>
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '15px' }}>
                  <div style={{ flex: '1', minWidth: '200px' }}>
                    ...
                    <p style={{ margin: '5px 0', fontSize: '15px' }}>
                      ...
                      {typeof basicDetails?.decoded_data?.customerDetails?.mealAllocation ===
                      'object'
                        ? Object.values(
              ...
              >
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', margin: '8px 0' }}>
                  ...
                  <span>
                    {basicDetails?.currency} {basicDetails?.paid_amount}
                  </span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', margin: '8px 0' }}>
                  <span style={{ color: '#555' }}>Balance Amount:</span>
                  <span>
                    {basicDetails?.currency} {basicDetails?.balance_amount}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '20px' }}>
              {/* Adult Guests */}
              <div style={{ flex: '1', minWidth: '250px' }}>
                <h5 style={{ margin: '0 0 10px 0', fontSize: '15px', color: '#2c3e50' }}>
                  Adults ({basicDetails?.decoded_data?.NoOfAdults || 0})
                </h5>
                <div
                  style={{
                    backgroundColor: '#fff',
                ...
                >
                  {basicDetails?.decoded_data?.paxDetails?.filter((data) => data?.PaxType == '1')
                    .length > 0 ? (
                    basicDetails?.decoded_data?.paxDetails
                      ?.filter((data) => data?.PaxType == '1')
                      .map((guest, i) => (
                        <div
                          key={i}
                          style={{
                            ...
                            borderBottom:
                              i <
                              basicDetails.decoded_data.paxDetails.filter(
                                (data) => data?.PaxType == '1',
                              ).length -
                                1
                                ? '1px solid #eee'
                    ...
                    <div style={{ padding: '8px', color: '#7f8c8d', fontStyle: 'italic' }}>
                      No adult guests
                    </div>
                  )}
                </div>
              ...
              <div style={{ flex: '1', minWidth: '250px' }}>
                <h5 style={{ margin: '0 0 10px 0', fontSize: '15px', color: '#2c3e50' }}>
                  Children ({basicDetails?.decoded_data?.NoOfChild || 0})
                </h5>
                <div
                  style={{
                    backgroundColor: '#fff',
                ...
                >
                  {basicDetails?.decoded_data?.paxDetails?.filter((data) => data?.PaxType == '2')
                    .length > 0 ? (
                    basicDetails?.decoded_data?.paxDetails
                      ?.filter((data) => data?.PaxType == '2')
                      .map((guest, i) => (
                        <div
                          key={i}
                          style={{
              ...
              <>
                ...
                >
                  <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                    <thead>
                      <tr style={{ borderBottom: '1px solid #eee' }}>
                        <th style={{ textAlign: 'left', padding: '8px', color: '#555' }}>
                          Check-in Date
                        </th>
                        <th style={{ textAlign: 'left', padding: '8px', color: '#555' }}>
                          Meal Plan
                      ...
                      'object' ? (
                        ...
                        <tr>
                          <td style={{ padding: '8px' }}>
                            {basicDetails?.decoded_data?.customerDetails?.check_in}
                          </td>
                          <td style={{ padding: '8px' }}>
                            {basicDetails?.decoded_data?.customerDetails?.mealAllocation}
                          </td>
          ...
          >
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '20px' }}>
              <div style={{ flex: '1', minWidth: '250px' }}>
                <h4 style={{ margin: '0 0 12px 0', fontSize: '16px', color: '#2c3e50' }}>
                  Supplier Details
                </h4>
                <p style={{ margin: '8px 0', fontSize: '15px' }}>
                  <span
      ...
      {props?.productData?.Provider === 'hotelTboH' && (
        ...
        >
            ...
            <div style={{ flex: '1', minWidth: '250px' }}>
              ...
              >
                ...
                <p style={{ margin: '8px 0', fontSize: '15px' }}>
                  ...
                  <span
                    style={{
                      color: bookingData?.BookingStatus
                        ? '#27ae60'
                        : props.productData?.status === 'Approved'
                        ? '#27ae60'
                        : '#e74c3c',
                      fontWeight: 'bold',
                      backgroundColor: bookingData?.BookingStatus
                        ? 'rgba(39, 174, 96, 0.1)'
                        : props.productData?.status === 'Approved'
                        ? 'rgba(39, 174, 96, 0.1)'
                        : 'rgba(231, 76, 60, 0.1)',
                ...
                <p style={{ margin: '8px 0', fontSize: '15px' }}>
                  ...
                  {bookingData?.BookingDate
                    ...
                    : new Date(props.productData.booked_date).toLocaleDateString('en-US', {
                        year: 'numeric',
                        month: 'long',
                        day: 'numeric',
                      })}
                  ...
                  <div style={{ textAlign: 'center', flex: '1' }}>
                    ...
                    >
                      {bookingData?.CheckIn
                        ...
                        : new Date(
                            props.productData.checkInDate.split('/').reverse().join('-'),
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', padding: '0 15px' }}>
                    ...
                    <div style={{ margin: '0 10px', color: '#555', fontSize: '14px' }}>
                      ...
                      {(bookingData?.CheckIn && bookingData?.CheckOut
                        ...
                        : props.productData?.NoOfNights || 1) > 1
                        ? 'Nights'
                        : 'Night'}
                    </div>
                    <div style={{ height: '1px', width: '50px', backgroundColor: '#ddd' }}></div>
                  ...
                  <div style={{ textAlign: 'center', flex: '1' }}>
                    ...
                    >
                      {bookingData?.CheckOut
                        ...
                        : new Date(
                            props?.productData?.checkOutDate?.split('/').reverse().join('-'),
                          ).toLocaleDateString('en-US', { month: 'short', day: 'numeric' })}
                    </p>
                    <p style={{ margin: '3px 0 0 0', fontSize: '14px' }}>
                      {bookingData?.CheckOut
            ...
            <div style={{ flex: '1', minWidth: '300px' }}>
              ...
              >
                {bookingData?.HotelDetails?.HotelName ||
                  props.productData?.hotelName ||
                  props.productData?.PName}
              </p>
              <div style={{ display: 'flex', alignItems: 'center', marginBottom: '10px' }}>
                <div style={{ display: 'inline-block' }}>
                  {Array(
                    bookingData?.HotelDetails?.StarRating ||
                      props.productData?.decoded_data?.hotelMainRequest?.hotelData?.class ||
                      4,
                  )
                    .fill(0)
                    .map((_, i) => (
              ...
              <p style={{ margin: '8px 0', fontSize: '15px' }}>
                ...
                {bookingData?.HotelDetails?.City ||
                  props.productData?.decoded_data?.hotelMainRequest?.hotelData?.city}
              </p>
            </div>
          ...
          {(
            bookingData?.Rooms || [
              props.productData?.decoded_data?.preBooking?.[0]?.Rooms?.[0] || {},
            ]
          ).map((room, index) => (
            <div
              key={index}
            ...
            >
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '25px', marginBottom: '20px' }}>
                <div style={{ flex: '2', minWidth: '300px' }}>
                  <h3 style={{ margin: '0 0 15px 0', color: '#2c3e50', fontSize: '18px' }}>
                    {room.Name?.[0] ||
                      props.productData?.decoded_data?.preBooking?.[0]?.RoomTypeName?.[0]}
                  </h3>
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: '15px' }}>
                    <div style={{ flex: '1', minWidth: '200px' }}>
                      <p style={{ margin: '5px 0', fontSize: '15px' }}>
                      ...
                      <p style={{ margin: '5px 0', fontSize: '15px' }}>
                        ...
                        {(
                          room.MealType ||
                          props.productData?.decoded_data?.preBooking?.[0]?.Inclusions?.[0]
                        )?.replace(/_/g, ' ')}
                      </p>
                      <p style={{ margin: '5px 0', fontSize: '15px' }}>
                ...
                >
                  ...
                  >
                    ...
                    <span style={{ fontWeight: 'bold' }}>
                      $
                      {(
                        (room.TotalFare || props.productData?.paid_amount) - (room.TotalTax || 0)
                      ).toFixed(2)}
                    </span>
                  </div>
                  <div
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '25px' }}>
                <div style={{ flex: '1', minWidth: '250px' }}>
                  ...
                  >
                    {(
                      ...
                      props.productData?.decoded_data?.paxDetails ||
                      []
                    ).map((guest, i) => (
                      <div
                        key={i}
                        style={{
                          ...
                          borderBottom:
                            i <
                            (room.CustomerDetails?.[0]?.CustomerNames?.length ||
                              props.productData?.decoded_data?.paxDetails?.length ||
                              1) -
                              1
                              ? '1px solid #eee'
                              : 'none',
                ...
                <div style={{ flex: '1', minWidth: '300px' }}>
                  ...
                  >
                    {(
                      room.CancelPolicies ||
                      props.productData?.decoded_data?.preBooking?.[0]?.CancellationPolicy ||
                      []
                    ).map((policy, i) => (
                      <div
                        key={i}
                      ...
                      >
                        <p style={{ margin: '0 0 5px 0', fontSize: '14px' }}>
                          <span style={{ fontWeight: 'bold' }}>
                            From {policy.FromDate?.substring(0, 10)}:
                          </span>
                        </p>
                        <p
                          style={{
                            margin: '0',
                            fontSize: '14px',
                            color: policy.CancellationCharge === 0 ? '#27ae60' : '#e74c3c',
                          }}
                        >
          ...
          >
            <div style={{ marginBottom: '20px' }}>
              ...
              <ul style={{ margin: '0', paddingLeft: '20px' }}>
                {(
                  bookingData?.RateConditions ||
                  props.productData?.decoded_data?.preBooking?.[0]?.RateConditions ||
                  []
                )
                  .filter(
                    (condition) =>
            ...
            {(
              ...
              props.productData?.decoded_data?.preBooking?.[0]?.RateConditions ||
              []
            ).some((condition) => condition?.includes('CheckIn Instructions')) && (
              <div style={{ marginBottom: '20px' }}>
                <h3 style={{ margin: '0 0 12px 0', color: '#2c3e50', fontSize: '18px' }}>
            ...
            {(
              ...
              props.productData?.decoded_data?.preBooking?.[0]?.RateConditions ||
              []
            ).some((condition) => condition?.includes('Special Instructions')) && (
              <div style={{ marginBottom: '20px' }}>
                <h3 style={{ margin: '0 0 12px 0', color: '#2c3e50', fontSize: '18px' }}>
            ...
            {(
              ...
              props.productData?.decoded_data?.preBooking?.[0]?.RateConditions ||
              []
            ).some((condition) => condition?.includes('Mandatory Fees')) && (
              <div style={{ marginBottom: '20px' }}>
                <h3 style={{ margin: '0 0 12px 0', color: '#2c3e50', fontSize: '18px' }}>
                  Mandatory Fees
                </h3>
            ...
            {(
              ...
              props.productData?.decoded_data?.preBooking?.[0]?.RateConditions ||
              []
            ).some((condition) => condition?.includes('Optional Fees')) && (
              <div style={{ marginBottom: '20px' }}>
                <h3 style={{ margin: '0 0 12px 0', color: '#2c3e50', fontSize: '18px' }}>
                  Optional Fees
                </h3>
            ...
            {(
              ...
              props.productData?.decoded_data?.preBooking?.[0]?.RateConditions ||
              []
            ).some((condition) => condition?.includes('Cards Accepted')) && (
              <div style={{ marginBottom: '20px' }}>
                <h3 style={{ margin: '0 0 12px 0', color: '#2c3e50', fontSize: '18px' }}>
                  Payment Information
                </h3>
            ...
            {(
              ...
              props.productData?.decoded_data?.preBooking?.[0]?.RateConditions ||
              []
            ).some((condition) => condition?.includes('Pets not allowed')) && (
              <div>
                <h3 style={{ margin: '0 0 12px 0', color: '#2c3e50', fontSize: '18px' }}>
                  Property Policies
                </h3>
        ...
        >
              ...
              >
                ...
                <p style={{ margin: '8px 0', fontSize: '15px' }}>
                  ...
                  <span
                    style={{
                      color:
                        props?.productData?.status === 'CustomerOrdered'
                          ? '#f39c12'
                          : props?.productData?.status === 'Confirmed'
                          ? '#27ae60'
                          : '#e74c3c',
                      fontWeight: 'bold',
                      backgroundColor:
              ...
              >
                ...
                >
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', padding: '0 15px' }}>
                    <div style={{ height: '1px', width: '50px', backgroundColor: '#ddd' }}></div>
                    <div style={{ margin: '0 10px', color: '#555', fontSize: '14px' }}>
                      {props?.productData?.NoOfNights}{' '}
                      {props?.productData?.NoOfNights > 1 ? 'Nights' : 'Night'}
                    </div>
                    <div style={{ height: '1px', width: '50px', backgroundColor: '#ddd' }}></div>
                  </div>
                  ...
                  <div style={{ textAlign: 'center', flex: '1' }}>
                    ...
                    >
                      {moment(props?.productData?.checkInDate, 'DD/MM/YYYY')
                        .add(props?.productData?.NoOfNights, 'days')
                        .format('MMM D')}
                    </p>
                    <p style={{ margin: '3px 0 0 0', fontSize: '14px' }}>
                      {moment(props?.productData?.checkInDate, 'DD/MM/YYYY')
          ...
          >
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '25px', marginBottom: '20px' }}>
              <div style={{ flex: '2', minWidth: '300px' }}>
                <h3 style={{ margin: '0 0 15px 0', color: '#2c3e50', fontSize: '18px' }}>
                  {props?.productData?.decoded_data?.hotelRatesRequest?.RoomTypeName ||
                    'Standard Room'}
                </h3>
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '15px' }}>
                  <div style={{ flex: '1', minWidth: '200px' }}>
              ...
              >
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', margin: '8px 0' }}>
                  <span style={{ color: '#555' }}>Paid Amount:</span>
                  <span>
                    {props?.productData?.currency} {props?.productData?.paid_amount}
                  </span>
                </div>
                <div style={{ display: 'flex', justifyContent: 'space-between', margin: '8px 0' }}>
                  <span style={{ color: '#555' }}>Balance Amount:</span>
                  <span>
                    {props?.productData?.currency} {props?.productData?.balance_amount}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '20px' }}>
              ...
              <div style={{ flex: '1', minWidth: '250px' }}>
                <h5 style={{ margin: '0 0 10px 0', fontSize: '15px', color: '#2c3e50' }}>
                  Adultss ({props?.productData?.NoOfAdults || 1})
                </h5>
                <div
                  style={{
                    backgroundColor: '#fff',
                ...
                >
                  {props?.productData?.decoded_data?.paxDetails?.filter(
                    (data) => data?.PaxType == '1',
                  ).length > 0 ? (
                    props?.productData?.decoded_data?.paxDetails
                      ?.filter((data) => data?.PaxType == '1')
              ...
              <div style={{ flex: '1', minWidth: '250px' }}>
                <h5 style={{ margin: '0 0 10px 0', fontSize: '15px', color: '#2c3e50' }}>
                  Children ({props?.productData?.decoded_data?.NoOfChild || 0})
                </h5>
                <div
                  style={{
                    backgroundColor: '#fff',
